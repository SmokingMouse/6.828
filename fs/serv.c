...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	if((r = file_read(of->o_file,ret->ret_buf,req->req_n,of->o_fd->fd_offset))<0) return r;
	of->o_fd->fd_offset += r;
	return r;
}
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	// LAB 5: Your code here.
	if((r = openfile_lookup(envid,req->req_fileid,&of)) < 0) return r;
	if((r = file_write(of->o_file,req->req_buf,req->req_n,of->o_fd->fd_offset)) < 0) return r;
	of->o_fd->fd_offset += r;
	return r;
